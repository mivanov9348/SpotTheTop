        ...
        <div className="card border-0 rounded-4 mb-4 shadow-lg" style={{ backgroundColor: '#1e293b' }}>
            <div className="card-body p-4">
                ...
                <div className="d-flex justify-content-between align-items-center border-top border-secondary pt-3 mt-2">
                    ...
                    <button 
                        className="btn btn-sm btn-outline-light rounded-pill px-3 opacity-75" 
                        onClick={() => {
                ...
                {showAdvanced && (
                    <div className="row g-3 pt-3 mt-3 border-top border-secondary border-dashed">
                        <div className="col-md-3">
                            <label className="form-label small text-light opacity-75 fw-bold mb-1">Age Range</label>
                            <div className="d-flex gap-2">
                                <input type="number" className="form-control form-control-sm bg-dark text-white border-secondary shadow-none placeholder-gray" placeholder="Min" value={minAge} onChange={e => setMinAge(e.target.value)} />
                                <span className="text-light opacity-50 align-self-center">-</span>
                                <input type="number" className="form-control form-control-sm bg-dark text-white border-secondary shadow-none placeholder-gray" placeholder="Max" value={maxAge} onChange={e => setMaxAge(e.target.value)} />
                            </div>
                        </div>

                        <div className="col-md-2">
                            <label className="form-label small text-light opacity-75 fw-bold mb-1">Min Height (cm)</label>
                            <input type="number" className="form-control form-control-sm bg-dark text-white border-secondary shadow-none placeholder-gray" placeholder="e.g. 185" value={minHeight} onChange={e => setMinHeight(e.target.value)} />
                        </div>

                        <div className="col-md-2">
                            <label className="form-label small text-light opacity-75 fw-bold mb-1">Preferred Foot</label>
                        ...
                        <div className="col-md-5">
                            <label className="form-label small text-info fw-bold mb-1">Performance (Min. Required)</label>
                            <div className="d-flex gap-2">
                                <input type="number" className="form-control form-control-sm bg-dark text-white border-info shadow-none placeholder-gray" placeholder="Matches" title="Matches Played" value={minMatches} onChange={e => setMinMatches(e.target.value)} />
                                <input type="number" className="form-control form-control-sm bg-dark text-white border-success shadow-none placeholder-gray" placeholder="Goals" title="Goals" value={minGoals} onChange={e => setMinGoals(e.target.value)} />
                                <input type="number" className="form-control form-control-sm bg-dark text-white border-primary shadow-none placeholder-gray" placeholder="Assists" title="Assists" value={minAssists} onChange={e => setMinAssists(e.target.value)} />
                                <input type="number" className="form-control form-control-sm bg-dark text-white border-danger shadow-none placeholder-gray" placeholder="Max Cards" title="Max Yellow/Red Cards allowed" value={maxCards} onChange={e => setMaxCards(e.target.value)} />
                            </div>
                        </div>
                    </div>
                )}
