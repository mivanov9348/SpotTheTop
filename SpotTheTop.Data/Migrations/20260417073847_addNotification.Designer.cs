...
namespace SpotTheTop.Data.Migrations
{
    ...
    [Migration("20260417073847_addNotification")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SpotTheTop.Core.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SpotTheTop.Core.Models.Like", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SpotTheTop.Core.Models.MatchEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SpotTheTop.Core.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SpotTheTop.Core.Models.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SpotTheTop.Core.Models.Comment", b =>
                {
                    b.HasOne("SpotTheTop.Core.Models.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("SpotTheTop.Core.Models.MatchEvent", b =>
                {
                    ...
                    b.HasOne("SpotTheTop.Core.Models.Player", "PrimaryPlayer")
                        .WithMany()
                        .HasForeignKey("PrimaryPlayerId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("SpotTheTop.Core.Models.Player", "SecondaryPlayer")
                        .WithMany()
